...
\title{CDBoost --- Implementation Notes\\
...
% ─────────────────────────────────────────────────────────────────────────────
\section*{CDBoost PDEVS}

CDBoost implements Parallel DEVS (PDEVS) as originally formulated.
The original PDEVS formalism does not specify a typed port system; CDBoost
...
\subsection*{Coupled Model Structure}
...
\begin{tabular}{@{}lll@{}}
  ...
  \midrule
  \texttt{double} & IEEE 754 double & $1/10$ not exact; accumulation error \\
  \texttt{boost::rational<int>} & exact fraction & no accumulation error; heavier compute \\
  \bottomrule
\end{tabular}
\end{center}
